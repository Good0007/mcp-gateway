...
const translations = {
  zh: {
    ...
    'connection.status.disconnect': '断开连接',
    ...
    'connection.toast.disconnected': '已断开连接',
    'connection.toast.reconnecting': '正在重连...',
    ...
    'xiaozhi.toast.disconnected': '已断开连接',
    ...
    'xiaozhi.connection.disconnect': '断开',
    ...
    'services.modal.startup_logs_title': '{name} 启动日志',
    'services.modal.startup_logs_processing': '处理中...',
    'services.modal.startup_logs_failed': '启动失败，请查看上方日志。',
  ...
  en: {
    ...
    'connection.status.disconnect': 'Disconnect',
    ...
    'connection.toast.disconnected': 'Disconnected',
    'connection.toast.reconnecting': 'Reconnecting...',
    ...
    'xiaozhi.toast.disconnected': 'Disconnected',
    ...
    'xiaozhi.connection.disconnect': 'Disconnect',
    ...
    'services.modal.startup_logs_title': '{name} Startup Logs',
    'services.modal.startup_logs_processing': 'Processing...',
    'services.modal.startup_logs_failed': 'Startup failed. Check logs above.',
